...
* `spacer` — транспортная проставка под тормозные колодки: ступенчатый
  язычок, тонкий конец под Shimano, весь целиком под SRAM;
...
KINDS: tuple[tuple[str, str], ...] = (
    ("spacer", "Проставка под колодки: язычок 2.8 мм (SRAM) с концом 1.8 мм (Shimano)"),
